...
export const CONFIG = {
    ...
    WHITELISTED_GUILDS: [
        getEnv("GUILD_ID"),
        getEnv("SECONDARY_GUILD_ID", false),
    ],
    DEVELOPER_USER_ID: getEnv("DEVELOPER_USER_ID"),
    ...
    CHANNELS: {
        ...
        VERIFY: getEnv("VERIFY_CHANNEL_ID"),
        PURCHASES: getEnv("PURCHASES_CHANNEL_ID"),
    },
    ROLES: {
        ...
        BLOODTRACE: getEnv("BLOODTRACE_ROLE_ID"),
        HEMOVISION: getEnv("HEMOVISION_ROLE_ID"),
        LEVELING: [
            {
